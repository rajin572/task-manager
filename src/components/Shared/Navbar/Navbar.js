                    ...
                    {user?.uid ? (
                      ...
                      <>
                        <Link
                          ...
                          aria-label="Sign in"
                          title="Sign in"
                          class="mb-5 inline-flex items-center justify-center font-medium tracking-wide  w-full text-white px-5 py-2 rounded bg-teal-500"
                        >
                          <button>Sign in</button>
                        </Link>
                        <Link
                          to="/signup"
                          class="inline-flex items-center justify-center w-full  font-medium tracking-wide text-white px-5 py-2 rounded bg-teal-500"
                          aria-label="Sign up"
                          title="Sign up"
                        >
